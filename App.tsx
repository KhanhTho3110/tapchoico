    ...
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-4 text-white relative overflow-hidden">
      ...
      <div className="z-10 max-w-md w-full bg-slate-900/80 backdrop-blur-xl border border-slate-800 p-8 rounded-2xl shadow-2xl">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-slate-400">Hạo Nhiên và An Nhiên tập chơi cờ Vua</p>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-3">
            <label className="text-sm uppercase tracking-wider font-bold text-slate-500">Thời Gian</label>
          ...
          <div className="space-y-3 pt-4 border-t border-slate-800">
            <label className="text-sm uppercase tracking-wider font-bold text-slate-500">Hai Người Chơi</label>
            <button
      ...
      <p className="absolute bottom-4 text-slate-600 text-xs">Xây dựng với React, Chess.js & Tailwind</p>
    </div>
  );
};
